        ...
        <Card className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="space-y-4">
            ...
            <Link
              ...
              external
              className="mt-4 inline-flex items-center justify-center min-h-[44px] rounded-none border border-accent bg-accent px-5 py-2.5 text-sm font-medium text-cream transition-smooth hover:opacity-90 active:scale-95"
            >
